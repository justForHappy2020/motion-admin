...
<!-- 添加动作的弹窗 -->
 ...
 <el-dialog width=90% title="动作管理/更新动作" :visible.sync="dialogTableVisible" :data="list" >
        ...
        <el-table v-loading="listLoading" :data="list" border style="width: 100%">
          ...
          <el-table-column  prop="actionImgs" label="图案" width="120">
            <template slot-scope="scope">
            　　      <img :src="scope.row.actionImgs" width="40" height="40" />
            </template>
          </el-table-column>
        
          <el-table-column prop="duration" label="说明" width="130">
          </el-table-column>
          <el-table-column prop="creator" label="创建人" width="130">
          </el-table-column>
          <el-table-column prop="uploadtime" label="添加时间" width="130">
          </el-table-column>
