      ...
      <div class="filter-container">
        <span>
          ...
          <el-row :gutter="10" >
            ...
            <el-col :span="5">
              <div>
                <el-input v-model="form.search_userKey" placeholder="请输入文章标题关键词"></el-input>
              </div>
            </el-col>
      ...
      <span>
        ...
        <el-table v-loading="listLoading" :data="list" border style="width: 100%">
          ...
          <el-table-column prop="gender" label="发布时间" width="150">
           ...
           <el-table-column prop="gender" label="发布状态" width="150">
                 <template slot-scope="scope">
              <span style="margin-left: 10px">{{ scope.row.type? "待审核" : "已发布，未发布" }}</span>
            </template>
          </el-table-column>
          <el-table-column prop="type" label="文章状态" width="150">
            <template slot-scope="scope">
              <span style="margin-left: 10px">{{ scope.row.type? "待审核" : "已被上架下架" }}</span>
            </template>
          </el-table-column>
